function createUnityInstance(t, n, l) {
  ...
  c.SystemInfo = function() {
    ...
    for (var l = [
      ...
      c = ((c = document.createElement("canvas")) && (gl = c.getContext("webgl2"), glVersion = gl ? 2 : 0, gl || (gl = c && c.getContext("webgl")) && (glVersion = 1), gl && (r = gl.getExtension("WEBGL_debug_renderer_info") && gl.getParameter(37446) || gl.getParameter(7937))), "undefined" != typeof SharedArrayBuffer),
  ...
  }, _), c.cachedFetch = (m = c.UnityCache, g = m.RequestStore, p = c.fetchWithProgress, C.prototype.arrayBuffer = function() {
    ...
    return o && (i.control = o.control, i.company = o.company, i.product = o.product), i.result = B(n, i.company, i.product, Date.now()), i.revalidated = !1, i.enabled ? a.loadRequest(i.result.url).then(function(e) {
      if (!e || e.version !== g.version) return s(r, o);
      ...
      return S("Failed to load '" + i.result.url + "' from indexedDB cache due to the error: " + e), p(r, o)
    }) : p(r, o)
  });
  var U = {
    gzip: {
        ...
        var t, n = {
          ...
          "zlib/inflate.js": function(e, t, n) {
            ...
            n.inflateReset = s, n.inflateReset2 = l, n.inflateResetKeep = i, n.inflateInit = function(e) {
              ...
              var n, r, o, a, i, s, l, d, u, c, f, h, b, m, g, p, w, v, y, k, x, _, S, E, C = 0,
                B = new L.Buf8(4),
              ...
              e: for (;;) switch (n.mode) {
                ...
                case 19:
                  for (; n.have < n.nlen + n.ndist;) {
                    for (; p = (C = n.lencode[d & (1 << n.lenbits) - 1]) >>> 16 & 255, w = 65535 & C, !((g = C >>> 24) <= u);) {
                      if (0 === s) break e;
                      s--, d += r[a++] << u, u += 8
                    }
                    if (w < 16) d >>>= g, u -= g, n.lens[n.have++] = w;
                    else {
                      if (16 === w) {
                        for (E = g + 2; u < E;) {
                          if (0 === s) break e;
                        ...
                        x = 0, h = 3 + (7 & (d >>>= g)), d >>>= 3, u = u - g - 3
                      } else {
                        for (E = g + 7; u < E;) {
                          if (0 === s) break e;
                          s--, d += r[a++] << u, u += 8
                        }
                        x = 0, h = 11 + (127 & (d >>>= g)), d >>>= 7, u = u - g - 7
                      }
                ...
                case 21:
                  ...
                  for (n.back = 0; p = (C = n.lencode[d & (1 << n.lenbits) - 1]) >>> 16 & 255, w = 65535 & C, !((g = C >>> 24) <= u);) {
                    if (0 === s) break e;
                    s--, d += r[a++] << u, u += 8
                  }
                  if (p && 0 == (240 & p)) {
                    for (v = g, y = p, k = w; p = (C = n.lencode[k + ((d & (1 << v + y) - 1) >> v)]) >>> 16 & 255, w = 65535 & C, !(v + (g = C >>> 24) <= u);) {
                      if (0 === s) break e;
                      s--, d += r[a++] << u, u += 8
                    }
                    d >>>= v, u -= v, n.back += v
                  }
                  if (d >>>= g, u -= g, n.back += g, n.length = w, 0 === p) {
                    n.mode = 26;
                    break
                  }
                  if (32 & p) {
                ...
                case 23:
                  for (; p = (C = n.distcode[d & (1 << n.distbits) - 1]) >>> 16 & 255, w = 65535 & C, !((g = C >>> 24) <= u);) {
                    if (0 === s) break e;
                    s--, d += r[a++] << u, u += 8
                  }
                  if (0 == (240 & p)) {
                    for (v = g, y = p, k = w; p = (C = n.distcode[k + ((d & (1 << v + y) - 1) >> v)]) >>> 16 & 255, w = 65535 & C, !(v + (g = C >>> 24) <= u);) {
                      if (0 === s) break e;
                      s--, d += r[a++] << u, u += 8
                    }
                    d >>>= v, u -= v, n.back += v
                  }
                  if (d >>>= g, u -= g, n.back += g, 64 & p) {
                ...
                for (x < 15 && (k += u[d++] << x, x += 8, k += u[d++] << x, x += 8), n = _[k & E];;) {
                  if (k >>>= r = n >>> 24, x -= r, 0 == (r = n >>> 16 & 255)) h[f++] = 65535 & n;
                    ...
                    for (o = 65535 & n, (r &= 15) && (x < r && (k += u[d++] << x, x += 8), o += k & (1 << r) - 1, k >>>= r, x -= r), x < 15 && (k += u[d++] << x, x += 8, k += u[d++] << x, x += 8), n = S[k & C];;) {
                      ...
                      if (a = 65535 & n, x < (r &= 15) && (k += u[d++] << x, (x += 8) < r && (k += u[d++] << x, x += 8)), g < (a += k & (1 << r) - 1)) {
          ...
          "zlib/inftrees.js": function(e, t, n) {
            ...
            t.exports = function(e, t, n, r, o, a, i, s) {
              for (var l, d, u, c, f, h, b, m, g, p = s.bits, w = 0, v = 0, y = 0, k = 0, x = 0, _ = 0, S = 0, E = 0, C = 0, B = 0, U = null, T = 0, R = new A.Buf16(16), L = new A.Buf16(16), O = null, I = 0, w = 0; w <= 15; w++) R[w] = 0;
              for (v = 0; v < r; v++) R[t[n + v]]++;
              for (x = p, k = 15; 1 <= k && 0 === R[k]; k--);
              if (k < x && (x = k), 0 === k) o[a++] = 20971520, o[a++] = 20971520, s.bits = 1;
                ...
                for (;;) {
                  for (g = i[v] < h ? (m = 0, i[v]) : i[v] > h ? (m = O[I + i[v]], U[T + i[v]]) : (m = 96, 0), l = 1 << (b = w - S), y = d = 1 << _; o[f + (B >> S) + (d -= l)] = b << 24 | m << 16 | g | 0, 0 !== d;);
                  for (l = 1 << w - 1; B & l;) l >>= 1;
